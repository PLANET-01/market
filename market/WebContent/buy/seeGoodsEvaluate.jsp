...
<body>
	...
	%>
		<tr>
			...
			<td><a href="BuyServlet?type=seeGoodsEvaluate&page=<%= page2 %>">回复（未实现）</a></td>
		</tr>
	<%
	}
	%>
	...
	<table>
		<tr>
			<td><a href="BuyServlet?type=seeGoodsEvaluate&page=<%= (page2-1)>=0? page2-1:0 %>">上一页</a></td>
			<td>当前页：<%= page2 %></td>
			<td><a href="BuyServlet?type=seeGoodsEvaluate&page=<%= (page2+1)>=0? page2+1:0 %>">下一页</a></td>
		</tr>	
	</table>
</body>
</html>