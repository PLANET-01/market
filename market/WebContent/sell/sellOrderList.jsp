...
<body>
	...
	%>
		<tr>
			...
			<td><a href="SellServlet?type=sellOrderInfo&orderID=<%= orders[i].getOrderID() %>">查看详情</a></td>
		</tr>
	<%
	}
	%>
	...
	<table>
		<tr>
			<td><a href="SellServlet?type=sellOrderList&page=<%= (page2-1)>=0? page2-1:0 %>">上一页</a></td>
			<td>当前页：<%= page2 %></td>
			<td><a href="SellServlet?type=sellOrderList&page=<%= (page2+1)>=0? page2+1:0 %>">下一页</a></td>
		</tr>	
	</table>
</body>
</html>